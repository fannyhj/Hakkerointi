...
- Automaattianalyysi tekee suurimman osan raskaista työstä, mutta manuaalinen puhdistus on myös välttämätöntä.

- Paikanna main() (Symbol tree:n kautta).
...
Avasin code browserin ja yritin etsiä etsiä main funktion, mutta semmoista ei ollut niin aluksi oletin, että se olisi FUN_0010578d ja uudelleennimesin sen main:iksi.
